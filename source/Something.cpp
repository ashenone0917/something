...
BEGIN_MESSAGE_MAP(CSomethingApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()

CSomethingApp::CSomethingApp()
{
	// 支持重新启动管理器
...
CSomethingApp theApp; // 唯一的 CSomethingApp 对象

BOOL CSomethingApp::InitInstance()
{
	// 如果一个运行在 Windows XP 上的应用程序清单指定要
	// 使用 ComCtl32.dll 版本 6 或更高版本来启用可视化方式，
	// 则需要 InitCommonControlsEx()，否则将无法创建窗口。
